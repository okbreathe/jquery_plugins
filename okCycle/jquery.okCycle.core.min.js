...
b.effect+"'"),!1):this.each(function(){var a=c(this),e=!1===b.preload?c(""):c("img",a);b.preload&&0<b.preload&&(b.loadOnShow&&(a.data(d,[]),e.slice(b.preload).each(function(){this._src=this.src;this.src="";a.data(d).push(c(this).hide()[0])})),e=e.slice(0,b.preload));b.ui.length&&(c.each(b.ui,function(a,b){q.push(c.okCycle.ui[b].init)}),a.data("ui",a.wrap("<div class='okCycle-ui'/>").parent()));a.data(g,0);c.each(q,function(c,d){d&&d.call(a,a.data("ui"),b)});e.imagesLoaded(function(){n.init.call(a,
b)});a.extend({pause:s,play:k,next:p,prev:t,moveTo:u});if(!0===b.autoplay||"number"==typeof b.autoPlay)setTimeout(function(){k.call(a)},isNaN(b.autoplay)?0:b.autoplay),"function"==typeof b.hoverBehavior&&b.hoverBehavior.call(a);b.afterSetup.call(a)})}})(jQuery);
