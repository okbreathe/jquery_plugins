...
function animate(list,finalHeight,finalOpacity,movementSpeed){var movementDuration=movementSpeed*list.data("maxHeight"),fadeDuration=opts.fadeSpeed*list.data("maxHeight");return list.stop(true,true).animate({height:finalHeight},(movementDuration>opts.maxDuration?opts.maxDuration:movementDuration),function(){list.animate({opacity:finalOpacity},(fadeDuration>opts.maxDuration?opts.maxDuration:fadeDuration));animating=false;}).toggleClass(opts.collapsedClass);}
