...
a.overlayClass+"' ></div>").appendTo("body").hide()));e=c(a.template).appendTo(a.parent).hide().extend({open:function(){return c.okPopup.open.call(this,b)},close:function(){return c.okPopup.close.call(this,b)},overlay:d,options:f(a)});if(a.show)c(b.selector).on(a.show,function(a){a.preventDefault();e.open(a.target)});if(a.hide)c(b.selector).on(a.hide,function(a){a.preventDefault();e.close(a.target)});return e},open:function(b){var a=this,e=this.options.content.call(b),d=c.isArray(this.options.where)?
